...
// DefaultGenesisConfig returns the default genesis configuration for Stable.
func DefaultGenesisConfig() network.GenesisConfig {
	return network.GenesisConfig{
		// Chain identity
		ChainIDPattern: "stable_{evmid}-1",
		...
		MinDeposit:       "10000000" + DefaultBaseDenom, // 10 STABLE
...
// ModifyGenesis applies Stable-specific modifications to a genesis file.
