...
func (m *mockStore) GetNode(ctx context.Context, devnetName string, index int) (*Node, error) {
	return nil, nil
}
...
func (m *mockStore) ListTransactions(ctx context.Context, devnetName string, opts ListTxOptions) ([]*Transaction, error) {
	return nil, nil
}
