...
func outputListJSON(result *dto.CacheListOutput) error {
...
func outputListText(result *dto.CacheListOutput) error {
...
func outputInfoJSON(cache ports.BinaryCache, symlinkInfo *ports.SymlinkInfo, stats ports.CacheStats) error {
...
func outputInfoText(cache ports.BinaryCache, symlinkInfo *ports.SymlinkInfo, stats ports.CacheStats) error {
